...
//    点击关于我们
    ...
    driver.findElement(By.xpath(".//*[@id='aboutUs-list']/li[2]/a")).click();
    Delay.delay(5);
    By locator3 = By.xpath("html/body/section[1]/div[2]/div[2]/h2");  
    Decide.isElementExsit(driver,locator3);  
    
    By locator4 = By.xpath("html/body/section[1]/div[2]/div[2]/ul/li[1]/div/p[1]");  
    Decide.isElementExsit(driver,locator4);  
    Snapshot.snapshot((TakesScreenshot) driver, "进入管理团队界面成功"+Datatime.getCurrentTime()+".png");
    driver.quit();
	}
}
