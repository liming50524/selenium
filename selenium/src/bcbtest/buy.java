...
//       点击第二栏的标
        WebElement test2=driver.findElement(By.xpath(".//*[@id='projectlist']/li[2]/a"));
        test2.click();
        Delay.delay(2);
        //点击登录后够买
...
//        账号和密码输入框 
        driver.findElement(By.xpath(".//*[@id='txt_mobile']")).sendKeys(new String[]{"15811853740"});
        Delay.delay(2);
...
//        输入金额100，点击购买
        ...
        Delay.delay(3);
//        判定是否弹出交易密码窗口
        By locator5 = By.xpath("html/body/div[3]/div/div/div/div/section/h2");  
        Decide.isElementExsit(driver,locator5); 
        Snapshot.snapshot((TakesScreenshot) driver, "弹出输入框"+Datatime.getCurrentTime()+".png");
        System.out.println("弹出密码输入框成功"); 
//        输入密码
        driver.findElement(By.xpath(".//*[@id='txt_invest_tradepwd']")).sendKeys(new String[]{"654321"});
        Delay.delay(1);
        driver.findElement(By.xpath("html/body/div[3]/div/div/div/div/section/input")).click();
        Delay.delay(5);
//        判定是否弹出支付成功字样
        By locator6=By.xpath("html/body/section[1]/div/ul/li[2]/p[4]");
