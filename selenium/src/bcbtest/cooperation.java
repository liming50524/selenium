...
//	    点击战略合作
	    driver.findElement(By.xpath(".//*[@id='aboutUs-list']/li[4]/a")).click();
	    Delay.delay(2);
        By locator3 = By.xpath("html/body/section[1]/div[2]/div[2]/h2");  
        Decide.isElementExsit(driver,locator3);  
        
        By locator4 = By.xpath("html/body/section[1]/div[2]/div[2]/ul/li[1]/img");  
        Decide.isElementExsit(driver,locator4);  
        
        By locator5 = By.xpath("html/body/section[1]/div[2]/div[2]/ul/li[1]/div/span");  
        Decide.isElementExsit(driver,locator5); 
        Snapshot.snapshot((TakesScreenshot) driver, "打开战略合作界面成功"+Datatime.getCurrentTime()+".png");
        driver.quit();
	}
}
