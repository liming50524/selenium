...
//	    点击工作机会
	    driver.findElement(By.xpath(".//*[@id='aboutUs-list']/li[5]/a")).click();
	    Delay.delay(2);
        By locator3 = By.xpath("html/body/section[1]/div[2]/div[2]/h2");  
        Decide.isElementExsit(driver,locator3);  
        
        By locator4 = By.xpath("html/body/section[1]/div[2]/div[2]/div[2]/div[1]/h2");  
        Decide.isElementExsit(driver,locator4);  
       
        Snapshot.snapshot((TakesScreenshot) driver, "打开工作机会界面成功"+Datatime.getCurrentTime()+".png");
        driver.quit();
	}
}
